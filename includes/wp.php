...
if ( ! function_exists( 'anesta_get_blog_title' ) ) {
	...
	function anesta_get_blog_title() {
		...
		if ( is_front_page() ) {
			...
			$title = esc_html__( 'Featured Businesses', 'anesta' );
		} elseif ( is_author() ) {
...
if ( ! function_exists( 'anesta_is_post_edit' ) ) {
	...
	function anesta_is_post_edit() {
		return ( anesta_check_url( 'post.php' ) && ! empty( $_GET['action'] ) && $_GET['action'] == 'edit')
				...
				||
				( anesta_check_url( '/block-renderer/trx-addons/' ) && ! empty( $_GET['context'] ) && $_GET['context'] == 'edit' )
				||
...
if ( ! function_exists( 'anesta_is_singular' ) ) {
	...
	function anesta_is_singular( $type = '' ) {
		global $wp_query;
		return apply_filters( 'anesta_filter_is_singular', ! empty( $wp_query->queried_object->ID ) && is_singular( $type ), $type );
	}
}
...
if ( ! function_exists( 'anesta_is_single' ) ) {
	...
	function anesta_is_single() {
		global $wp_query;
		return apply_filters( 'anesta_filter_is_single', ! empty( $wp_query->queried_object->ID ) && is_single() );
	}
}
